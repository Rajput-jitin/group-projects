...
class Scheme(Base):
    ...
    documents_text: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    process_text: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    eligible_genders: Mapped[Optional[List[str]]] = mapped_column(JSON, nullable=True)  # null = any
    income_min: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    income_max: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    eligible_categories: Mapped[Optional[List[str]]] = mapped_column(JSON, nullable=True)
    eligible_states: Mapped[Optional[List[str]]] = mapped_column(JSON, nullable=True)  # null = all-India
    eligible_occupations: Mapped[Optional[List[str]]] = mapped_column(JSON, nullable=True)
    eligible_education_levels: Mapped[Optional[List[str]]] = mapped_column(JSON, nullable=True)
    disability_required: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)  # None = not required
    rural_only: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)

    application_start_date: Mapped[Optional[date]] = mapped_column(Date, nullable=True)
