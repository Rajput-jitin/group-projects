...
class EligibilityCheck(Base):
    ...
    scheme_id: Mapped[Optional[uuid.UUID]] = mapped_column(String(36), ForeignKey("schemes.id"), nullable=True)
    ...
    missing_requirements: Mapped[Optional[List]] = mapped_column(JSON, nullable=True)
    matched_criteria: Mapped[Optional[List]] = mapped_column(JSON, nullable=True)
