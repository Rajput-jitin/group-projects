...
cors_origins = list(set(settings.cors_origins_list + [
    ...
    "http://127.0.0.1:3000",
    "http://127.0.0.1:3001",
    "https://group-projects.onrender.com",
]))
...
def auto_seed_if_empty():
    ...
    try:
        ...
        if count == 0:
            print("[INFO] Database is empty. Running scheme auto-seeder...")
            from scripts.seed_myschemes import main as run_seed
            run_seed()
    except Exception as e:
        print(f"[WARNING] Auto-seeding check skipped: {e}")
    finally:
        db.close()
